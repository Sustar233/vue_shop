<template>
  <div>
    ...
    <el-dialog
      ...
      <!-- 内容主体区 -->
      <el-form :model="addForm" :rules="addFormFules" ref="addFormRef" label-width="100px" class="demo-ruleForm">
    ...
    >
      <el-form :model="editForm" :rules="addFormFules" ref="editFormRef" label-width="70px">
        <el-form-item label="角色名称" prop="roleName">
